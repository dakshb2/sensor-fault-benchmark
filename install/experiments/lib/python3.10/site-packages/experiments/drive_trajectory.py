...
class TrajectoryDriver(Node):
    def __init__(self):
        ...
        # Latched so an injector that starts late still receives the signal.
        latched = QoSProfile(
            depth=1,
    ...
    def _tick(self):
        ...
        if self._segment_start is None:
            ...
            self.get_logger().info(
                'Starting trajectory (simulation time). /trial/started published.')
